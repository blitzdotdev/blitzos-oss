...
// The grantee named in every title/why is "BlitzOS Automation" — the helper bundle that actually HOLDS these
// macOS grants (dev.blitz.os.computeruse), so the card copy matches the exact row the user sees in System
// Settings. "Blitz" stays the product; "BlitzOS Automation" is the thing they grant. (The Chrome Allow-JS grant
// is a Chrome setting, not a helper TCC row, but the helper is still what reads the tabs, so it's named too.)
export const GRANTS = {
  accessibility: {
    grant: 'accessibility',
    title: 'Let BlitzOS Automation control your apps',
    why: 'BlitzOS Automation needs Accessibility to see and operate app windows for you.',
  ...
  screen: {
    grant: 'screen',
    title: 'Let BlitzOS Automation see your screen',
    why: 'BlitzOS Automation needs Screen Recording to see what is on screen and click accurately.',
  ...
  'automation:systemevents': {
    ...
    title: 'Let BlitzOS Automation drive menus',
    why: 'BlitzOS Automation needs permission to control System Events so it can open menus for you.',
  ...
  'automation:chrome': {
    ...
    title: 'Let BlitzOS Automation work in Chrome',
    why: 'BlitzOS Automation needs permission to control Google Chrome so it can act in your tabs.',
    button: 'Grant permission',
    settings: PRIVACY + 'Privacy_Automation',
  ...
  'automation:safari': {
    ...
    title: 'Let BlitzOS Automation work in Safari',
    why: 'BlitzOS Automation needs permission to control Safari so it can act in your tabs.',
    button: 'Grant permission',
    settings: PRIVACY + 'Privacy_Automation',
    kind: 'prompt'
  },
  'allowjs:chrome': {
    ...
    why: 'Chrome needs "Allow JavaScript from Apple Events" (a one-time setting) so BlitzOS Automation can read and act in tabs.',
    button: 'Turn it on',
    settings: '',
    kind: 'allowjs'
  }
